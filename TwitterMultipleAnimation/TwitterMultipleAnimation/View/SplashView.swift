...
// Make your own protocol as [er reuirement with some return value and more parameter
@objc protocol SplashViewProtocol {
    @objc optional
        func didBeginAnimatingWithDuration(duration:Double)
    @objc optional
...
class SplashView: UIView {
    ...
    //---------------------------------
    //--- As per requirement use the protocol
    //---------------------------------
    ...
    //---------------------------------
    open var continousAnimation: Bool = true
